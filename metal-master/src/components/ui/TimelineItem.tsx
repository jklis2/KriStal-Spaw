...
const TimelineItem: React.FC<TimelineItemProps> = ({
  ...
  return (
    <div 
      className={`relative pl-12 group p-6 rounded-lg border border-transparent transition-all duration-500 hover:bg-industrialGray hover:border-weldingRed/20 ${isInView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-[30px]'}`}
    ...
    >
      ...
      <div className="relative">
        ...
        <h3 className="font-oswald text-xl mb-2 text-gray-900">{title}</h3>
