...
export default function OfferCard({ title, description, image, features }: OfferCardProps) {
  return (
    <div 
    ...
    >
      ...
      <div className="p-8 relative">
        <h3 className="text-3xl font-bold font-oswald text-white mb-4">{title}</h3>
        ...
        <button className="w-full py-4 px-8 bg-weldingRed/10 hover:bg-weldingRed/20 
