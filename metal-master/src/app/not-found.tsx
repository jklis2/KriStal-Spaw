  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center p-6 relative overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-3xl mx-auto animate-fade-in-only">
        ...
        <h1 
          className="text-7xl font-extrabold mb-4 font-oswald animate-fade-up text-gray-900"
        ...
        <p 
          className="italic mb-8 font-roboto animate-fade-up text-gray-500"
      ...
      >
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          <div className="hover:scale-105 active:scale-[0.98] transition-transform duration-300">
            <Link href="/" className="flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 text-gray-700 hover:bg-weldingRed/10 hover:text-weldingRed transition-colors duration-300">
              <FaHome />
          ...
          <div className="hover:scale-105 active:scale-[0.98] transition-transform duration-300">
            <Link href="/oferta" className="flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 text-gray-700 hover:bg-weldingRed/10 hover:text-weldingRed transition-colors duration-300">
              <FaTools />
              <span>Oferta</span>
            </Link>
          </div>
          ...
          <div className="hover:scale-105 active:scale-[0.98] transition-transform duration-300">
            <Link href="/galeria" className="flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 text-gray-700 hover:bg-weldingRed/10 hover:text-weldingRed transition-colors duration-300">
              <FaImages />
              <span>Galeria</span>
            </Link>
          </div>
          ...
          <div className="hover:scale-105 active:scale-[0.98] transition-transform duration-300">
            <Link href="/kontakt" className="flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 text-gray-700 hover:bg-weldingRed/10 hover:text-weldingRed transition-colors duration-300">
              <FaEnvelope />
              <span>Kontakt</span>
            </Link>
          </div>
