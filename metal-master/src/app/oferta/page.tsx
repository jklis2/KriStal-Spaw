  ...
  const offers = [
    {
      title: "Bramy kute",
      description:
        "Ręcznie wykonane bramy z najwyższej jakości stali, łączące tradycyjne rzemiosło z nowoczesnymi technikami obróbki metalu.",
    ...
    },
    {
      title: "Ogrodzenia",
      description:
        "Kompleksowe rozwiązania ogrodzeniowe, od klasycznych po nowoczesne wzory, wykonane z dbałością o każdy detal.",
    ...
    },
    {
      title: "Balustrady",
      description:
        "Eleganckie i trwałe balustrady schodowe i balkonowe, zapewniające bezpieczeństwo i podkreślające charakter wnętrza.",
    ...
    },
    {
      ...
      description:
        "Unikalne meble łączące metal i drewno, tworzone na zamówienie według indywidualnych projektów.",
