    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6 animate-fade-in-only">
        {contactItems.map((item, index) => (
          ...
          >
            <div className="w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0 transform transition-all duration-300 group-hover:scale-110 bg-weldingRed/20 group-hover:bg-weldingRed/30">
