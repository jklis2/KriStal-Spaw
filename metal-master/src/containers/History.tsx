    ...
    <section className="py-24 bg-industrialGray relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative">
        <div className="text-center mb-16">
          ...
          <p className="mt-8 text-xl font-roboto text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            {milestones.map((milestone, index) => (
              <div key={index} className="relative pl-12 group hover:bg-gray-900/30 p-6 rounded-lg transition-all duration-300">
                ...
                <div className="relative">
                  ...
                  <h3 className="text-white font-oswald text-xl mb-2">{milestone.title}</h3>
